...
public class RegionDAOJdbcImpl extends AbstractJdbcDAO implements RegionDAO{
	...
	private static final String SQL_FIND_REGIONS_BY_COUNTRY_ID = "SELECT region_id, region_name, country_id FROM regions WHERE country_id = ?";
	...
	@Override
	public Collection<Region> findByCountryId(long id) throws DAOException {
		List<Region> regions = jdbcTemplate.query(SQL_FIND_REGIONS_BY_COUNTRY_ID, new Object[]{id}, new RegionMapper());
		return regions;
	}	
